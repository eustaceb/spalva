// This is a modified version of imgui_impl, adapted for Glad.
// Original can be found https://github.com/ocornut/imgui
...
// This enables ComboBox, ListBox usage with std::vector<std::string>
namespace ImGui
{
...
void ImGui_NewFrame()
{
    ...
    // Start the frame
    ImGui::NewFrame();
    ImGui::End(); // Remove the debug window
}
